...
thank you again for applying for Junior Full-Stack developer position at Erento. With the following task we would like to verify that you know what coding means.
...
2. Remove `node_modules` folder in both applications pack it into archive and send it over an email.
